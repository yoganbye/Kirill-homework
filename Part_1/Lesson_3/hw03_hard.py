...
"""
Для того чтобы проверить нужную дату, можно изменять ниже описанный пример
или для более удобного пользования комментировать/разкомментировать не нужные 
элементы
"""
